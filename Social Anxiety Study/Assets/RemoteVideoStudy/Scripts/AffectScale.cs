...
//                {
//                    EmteqManager.SetDataPoint("Valence:" + valence + ", Arousal:" + arousal + ", RawX:" + Controller.UPvr_GetTouchPadPosition(hand).y + ", RawY:" + Controller.UPvr_GetTouchPadPosition(hand).x);
...
//    {
//        yPicoRaw.text = "Pico raw Y2: " + Controller.UPvr_GetTouchPadPosition(hand).y.ToString();
//        xPicoRaw.text = "Pico raw X2: " + Controller.UPvr_GetTouchPadPosition(hand).x.ToString();
//    }
